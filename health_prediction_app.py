...
with col1:
    ...
    АСТ = st.number_input("**АСТ (ед/л)**", min_value=0.0, max_value=200.0, value=30.0)
    ГГТП = st.number_input("**ГГТП (ед/л)**", min_value=0.0, max_value=200.0, value=15.0)
    О_белок = st.number_input("**Общий белок (г/л)**", min_value=0.0, max_value=200.0, value=70.0)
